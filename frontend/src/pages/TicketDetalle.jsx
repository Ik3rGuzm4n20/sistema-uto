...
import { obtenerTicketPorId, actualizarEstado } from '../services/ticketService'
        ...
        <div style={estilos.card}>
          ...
          {esStaff && (
            <div style={estilos.cambiarEstado}>
              <label style={estilos.label}>Cambiar estado del ticket:</label>
              <select
                defaultValue=""
...
const estilos = {
  contenedor: { fontFamily: 'Arial, sans-serif', minHeight: '100vh', width: '100%', backgroundColor: '#F2F2F2' },
  navbar: { backgroundColor: '#1F3864', padding: '15px 30px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  logoNav: { color: 'white', margin: 0 },
  botonNav: { backgroundColor: '#2E75B6', color: 'white', border: 'none', padding: '8px 16px', borderRadius: '6px', cursor: 'pointer', fontSize: '14px' },
  contenido: { padding: '30px', maxWidth: '900px', margin: '0 auto' },
  card: { backgroundColor: 'white', padding: '25px', borderRadius: '8px', boxShadow: '0 2px 6px rgba(0,0,0,0.08)', marginBottom: '20px' },
  encabezado: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '15px', flexWrap: 'wrap', gap: '10px' },
  codigo: { color: '#1F3864', margin: 0, fontSize: '24px' },
  tituloTicket: { color: '#333', margin: '5px 0 0', fontSize: '18px', fontWeight: 'normal' },
  badges: { display: 'flex', gap: '8px' },
  badge: { color: 'white', padding: '6px 12px', borderRadius: '4px', fontSize: '12px', fontWeight: 'bold', height: 'fit-content' },
  descripcion: { color: '#555', backgroundColor: '#F9F9F9', padding: '15px', borderRadius: '6px', marginBottom: '15px', lineHeight: '1.5' },
  ...
  subtituloHilo: { color: '#1F3864', margin: '0 0 15px', fontSize: '18px' },
  sinComentarios: { color: '#999', fontSize: '14px', fontStyle: 'italic' },
  hilo: { display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '20px' },
  mensaje: { backgroundColor: '#F2F2F2', borderRadius: '6px', padding: '12px 15px', borderLeft: '4px solid #2E75B6' },
  mensajeNota: { backgroundColor: '#FFF2CC', borderLeft: '4px solid #FFC000' },
  mensajeHeader: { display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px', flexWrap: 'wrap' },
  tagNota: { backgroundColor: '#FFC000', color: '#7F6000', fontSize: '10px', fontWeight: 'bold', padding: '2px 8px', borderRadius: '4px' },
  fecha: { color: '#999', fontSize: '12px', marginLeft: 'auto' },
  mensajeTexto: { margin: 0, color: '#333', fontSize: '14px', lineHeight: '1.5', whiteSpace: 'pre-wrap' },
  formulario: { borderTop: '1px solid #eee', paddingTop: '15px' },
  textarea: { width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid #BDD7EE', fontSize: '14px', fontFamily: 'Arial, sans-serif', resize: 'vertical', backgroundColor: '#e7e7e7', color: '#2b2727', boxSizing: 'border-box' },
  formularioFooter: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '10px', flexWrap: 'wrap', gap: '10px' },
  checkboxLabel: { fontSize: '13px', color: '#666', display: 'flex', alignItems: 'center', gap: '5px' },
  botonEnviar: { backgroundColor: '#1F3864', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '6px', cursor: 'pointer', fontSize: '14px', fontWeight: 'bold' }
}
